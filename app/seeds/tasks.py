...
def seed_tasks():
    ...
    p1_task1 = Task(
        project_id=1,
        complete=False,
        title='Review Simon, might fire him',
        user_id=1,
        due_date=today,
        description='Need to meet with Simon and discuss progress'
    )
    ...
    p1_task2 = Task(
        project_id=1,
        complete=False,
        title='Give Nico access to backend resources and login',
        user_id=1,
        due_date=today,
    ...
    p1_task3 = Task(
        project_id=1,
        complete=False,
        title='Ask Pierre why he so smart',
        user_id=1,
        due_date=today,
    ...
    p1_task5 = Task(
        project_id=1,
        complete=False,
        title='Yell at andru, he needs to meet the dead lines',
        user_id=None,
        due_date=None,
        description='WHAT DO I DO WITH THIS GUY '
    )
